...
function Card({ card, handleCardClick, onCardLike, onCardDelete }) {
  ...
  return (
    <li className="elements__item">
      <img className="elements__image" src={card.link} alt={card.name} onClick={onClick} />
      ...
      <button type="button" className={deleteButtonClass} onClick={handleDeleteCard}></button>
    </li>
  );
}
